                            ...
                            <form method="post">
                                ...
                                <div style="background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 25px; margin-bottom: 25px; box-shadow: var(--sm-shadow);">
                                    ...
                                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; margin-top:15px;">
                                        ...
                                        <div class="sm-form-group"><label class="sm-label">الرمز البريدي (Postal Code):</label><input type="text" name="syndicate_postal_code" value="<?php echo esc_attr($syndicate['postal_code'] ?? ''); ?>" class="sm-input"></div>
